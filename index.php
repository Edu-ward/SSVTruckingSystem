...
<body class="bg-slate-900 dark:bg-gray-900 h-screen flex items-center justify-center">
    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-2xl w-96 border-t-4 border-blue-600">
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-slate-800 dark:text-gray-200">Login</h1>
        </div>
        ...
        <form action="auth.php" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="password" name="password" required class="w-full border p-2 rounded focus:outline-none focus:border-blue-500" placeholder="Password">
            </div>
