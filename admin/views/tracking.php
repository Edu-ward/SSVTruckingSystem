                    ...
                    <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition bg-gray-50">
                        <div class="flex justify-between items-start mb-2">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <div class="font-bold text-gray-800"><?= htmlspecialchars($truck['truck_code']); ?></div>
                                    <div class="text-sm text-gray-500"><?= htmlspecialchars($truck['driver_name']); ?></div>
                                </div>
                            </div>
                        ...
                        <?php if ($truck['status'] == 'Loading'): ?>
                            <div class="mt-4 bg-indigo-50 border border-indigo-100 rounded-lg p-3 loading-timer-container" data-truck-id="<?= $truck['truck_code']; ?>">
                        ...
                        <button onclick="focusTruck(<?= $truck['latitude']; ?>, <?= $truck['longitude']; ?>)" class="mt-4 w-full bg-white border border-gray-300 hover:bg-gray-100 text-gray-700 text-sm font-semibold py-2 rounded-lg transition flex items-center justify-center space-x-2 shadow-sm">
