            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/80 p-5 flex flex-col max-h-[780px]">
                    <div class="flex items-center justify-between mb-4 px-1">
                        ...
                        <span id="active-fleet-count" class="text-xs font-semibold px-2.5 py-1 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300">
                            <?= count($trackingTrucks); ?> <?= count($trackingTrucks) === 1 ? 'Vehicle' : 'Vehicles'; ?>
                        </span>
                    </div>

                    <div id="active-fleet-list" class="overflow-y-auto space-y-3.5 pr-1">
                        <?php if (empty($trackingTrucks)): ?>
                            <div class="text-center py-10 px-4 rounded-2xl border border-dashed border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/40">
                                <div class="w-12 h-12 rounded-2xl bg-blue-50 dark:bg-blue-900/30 text-blue-500 flex items-center justify-center mx-auto mb-3">
                                    <i class="fa-solid fa-truck text-base"></i>
                                </div>
                                <p class="text-xs font-semibold text-gray-700 dark:text-gray-300">No Dispatches in Transit</p>
                                <p class="text-[11px] text-gray-400 dark:text-gray-500 mt-1">Trucks will appear on the map once dispatched.</p>
                            </div>
                        <?php else: ?>
