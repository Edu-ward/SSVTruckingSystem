            ...
            <div class="overflow-y-auto space-y-4">
                ...
                ?>
                    <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-md transition bg-gray-50 dark:bg-gray-900">
                        ...
                        <button onclick="focusTruck(<?= $truck['latitude']; ?>, <?= $truck['longitude']; ?>)" class="mt-4 w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm font-semibold py-2 rounded-lg transition flex items-center justify-center space-x-2 shadow-sm">
