<div id="view-dashboard" class="tab-content block">
    ...
    <div class="grid grid-cols-2 gap-6 mb-6">
        <div class="bg-white rounded-xl shadow p-6 border border-gray-100">
            <h3 class="font-semibold text-gray-800 mb-4">Weekly Dispatch Activity</h3>
    ...
    <div class="grid grid-cols-3 gap-6 mb-6">
        <div class="col-span-2 bg-white rounded-xl shadow p-6 border border-gray-100">
            <h3 class="font-semibold text-gray-800 mb-4">Delivery Efficiency Trend</h3>
    ...
    <div class="bg-white rounded-xl shadow border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100">
            <h3 class="font-semibold text-gray-800">Recent Dispatch Activity</h3>
        </div>
