    ...
    <nav class="bg-[#3b82f6] text-white py-4 px-6 shadow-md">
        <div class="flex justify-between items-center max-w-7xl mx-auto">
            ...
            <div class="hidden md:flex items-center space-x-6 text-sm font-medium">
                <span class="text-blue-100">Welcome, <?php echo htmlspecialchars($_SESSION['username']); ?></span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-[#4a8df8] rounded-xl p-6 text-white relative overflow-hidden shadow-sm">
                <div class="relative z-10">
                    ...
                    <h3 class="text-4xl font-bold tracking-tight">₱<?php echo number_format($payroll['total_amount'], 2); ?></h3>
            ...
            <div class="bg-[#2ccb72] rounded-xl p-6 text-white relative overflow-hidden shadow-sm">
                <div class="relative z-10">
                    ...
                    <h3 class="text-4xl font-bold tracking-tight">₱<?php echo number_format($payroll['amount_claimed'], 2); ?></h3>
            ...
            <div class="bg-[#fa7d20] rounded-xl p-6 text-white relative overflow-hidden shadow-sm">
                <div class="relative z-10">
                    ...
                    <h3 class="text-4xl font-bold tracking-tight">₱<?php echo number_format($payroll['available_balance'], 2); ?></h3>
                        ...
                        <?php if (count($trips) > 0): ?>
                            <?php foreach ($trips as $trip): ?>
                                <tr class="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                                    <td class="py-4 px-2"><?php echo date('M d, Y', strtotime($trip['trip_date'])); ?></td>
                                    <td class="py-4 px-2 font-medium"><?php echo htmlspecialchars($trip['destination']); ?></td>
                                    <td class="py-4 px-2">
                                        ...
                                        <?php else: ?>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                <i class="fa-solid fa-truck-fast mr-1"></i> <?php echo htmlspecialchars($trip['status']); ?>
                                            </span>
                                        <?php endif; ?>
                                    </td>
                                </tr>
